...
# Calculamos el EMV para la media (media muestral) y la desviación estándar de 'GillColor.numeric'
...
hist(gillcolor_data, 
     main = "Distribución muestral de 'GillColor.numeric'", 
...
hist(teorica_gillcolor, 
     main = "Distribución teórica de 'GillColor.numeric'", 
     xlab = "GillColor (numérico)", 
     col = "lightgreen", 
     border = "white", 
     probability = TRUE)
...
# Filtrar las observaciones con valores cero en GillColor.numeric
mushroom_filtrado <- mushroom.muestra %>%
...
# Calcular el EMV de la media y la varianza (desviación estándar)
emv_media_log <- mean(mushroom_filtrado$GillColor.log)
emv_var_log <- var(mushroom_filtrado$GillColor.log)  # Varianza muestral
emv_desv_log <- sqrt(emv_var_log)  # Desviación estándar

# Imprimir los resultados
print(paste("Estimador de máxima verosimilitud de la media (EMV) de log(GillColor.numeric):", emv_media_log))
print(paste("Estimador de máxima verosimilitud de la desviación estándar de log(GillColor.numeric):", emv_desv_log))

# Comparar la distribución muestral con la distribución teórica
# Histograma de la variable logarítmica
ggplot(mushroom_filtrado, aes(x = GillColor.log)) +
  ...
  stat_function(fun = dnorm, args = list(mean = emv_media_log, sd = emv_desv_log), 
                color = "red", size = 1) +
  labs(title = "Distribución Muestral vs. Distribución Teórica",
       x = "log(GillColor.numeric)",
       y = "Densidad") +
  theme_minimal()
